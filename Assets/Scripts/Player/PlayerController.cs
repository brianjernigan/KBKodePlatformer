...
public class PlayerController : MonoBehaviour
{
    ...
    {
        var targetSpeed = InputManager.Instance.HorizontalInput * MaxMoveSpeed;

        CurrentSpeed = InputManager.Instance.HorizontalInput != 0f ? 
    ...
    {
        if (Mathf.Abs(InputManager.Instance.HorizontalInput) <= 0.01f) return;

        var isFacingRight = InputManager.Instance.HorizontalInput > 0f;
